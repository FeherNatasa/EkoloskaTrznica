...
<div class="row">
    <div class="column left">
        <img src="Slike/logoBeli.png" class="onas" height="100px" width="300px" align="right">
    </div>
    <div class="column middle">
        <p>Vizija podjetja EKO Hiška je približati ekološke pridelke vsakemu kupcu na čim preprostejši in cenovno ugoden način. </p>
